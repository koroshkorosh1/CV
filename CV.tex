...
\vspace{0.71 em}
	...
	\begin{itemize}
		\item \authorimg{Images/GESTCO.jpg}  \textbf{Fault Diagnosis Method for Chemical Process} - \textcolor{gray}{Shiraz University}    \hfill\textcolor{gray}{(Group Project)}   [Present]
		\begin{itemize}
	...
	\section{INTERNSHIP}
	\begin{itemize}
		\item \authorimg{Images/sapra.png}  \textbf{Peyman Sanat Sapra Company}  \textcolor{gray}     \hfill\textcolor{gray}   [Present]
		\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
			...
			\vspace{0.5em} 
	     	...
	     	% \begin{itemize}
	     	%\begin{itemize}
			\item \authorimg{Images/aut.png} Physical Chemistry  \hfill[Present]
			\begin{itemize} 
       ...
       \vspace{0.5em} 
	     	...
	     	% \begin{itemize}
	     	%\begin{itemize}
			\item \authorimg{Images/aut.png} Engineering Mathematics  \hfill[Present]
			\begin{itemize} 
